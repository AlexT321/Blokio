<template>
  <div class="w-screen h-screen bg-zinc-900 flex justify-between items-center flex-col overflow-hidden">
    <Header_main/>
    <div class="h-full w-full flex xl:justify-center items-center flex-row">
      <Side_menu/>
      <div class="h-full w-[180vh] bg-zinc-800 flex justify-center sm:items-center flex-col gap-2 overflow-auto">
        <div class=" relative h-[80vh] w-[98%] sm:w-[50vw] 2xl:w-[78vw] min-w-[350px] bg-zinc-700">
          <!-- <Call_overlay/> -->
          <Message/>
          <!-- <Chat_overlay/> -->
        </div>
        <div class=" h-12 2xl:w-[78vw] sm:w-[50vw] w-[98%] min-w-[350px] bg-zinc-500 rounded-3xl flex flex-row justify-center items-center pl-5 pr-5 gap-5">
          <button class="h-12 w-12 min-w-[50px] text-3xl flex justify-center items-center text-zinc-800 pb-1">+</button>
          ...
          <button class=" h-8 w-8 min-w-[30px] rounded-full bg-blue-500 text-white flex justify-center items-center">
